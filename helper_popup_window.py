...
def error_popup():
    ...
    pt = Popup(title='Something Wrong during process:',content=content, size_hint=(None, None), size=(400, 400),)
...
def ok_popup(file_name):
    ...
    pt = Popup(title='Convertion Done',content=content, size_hint=(None, None), size=(400, 400),)
    content.bind(on_press=pt.dismiss)
    pt.open()